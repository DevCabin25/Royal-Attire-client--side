	...
	return (
		<div className='px-8 mx-auto min-h-screen bg-gray-300 pb-6 '>
			<div className='flex gap-4'>
				...
				<div className='bg-white rounded-xl mt-4 w-[60%] p-4'>
				...
				<div className=' relative text-center text-xl mt-4 w-[50%] mx-auto flex justify-center items-center bg-white rounded-xl'>
					<div className=''>
						<p className='absolute -top-9 right-3 w-20 h-20 bg-black rounded-full transform rotate-45 translate-x-8 translate-y-8 opacity-50'></p>
						<p className='absolute top-44 right-[500px]	 w-20 h-20 bg-black rounded-full transform rotate-45 translate-x-8 translate-y-8 opacity-50'></p>
